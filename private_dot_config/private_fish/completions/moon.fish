...
function __fish_moon_global_optspecs
	string join \n cache= color c/concurrency= dump log= logFile= q/quiet h/help V/version
end
...
complete -c moon -n "__fish_moon_needs_command" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand completions" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand init" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -l cache -d 'Mode for cache operations' -r
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -s c -l concurrency -d 'Maximum number of threads to utilize' -r
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -l log -d 'Lowest log level to output' -r
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -l logFile -d 'Path to a file to write logs to' -r -F
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -l color -d 'Force colored output'
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -l dump -d 'Dump a trace profile to the working directory'
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -s q -l quiet -d 'Hide all non-important terminal output'
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -s h -l help -d 'Print help'
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -s V -l version -d 'Print version'
complete -c moon -n "__fish_moon_using_subcommand debug; and not __fish_seen_subcommand_from vcs" -f -a "vcs" -d 'Debug the VCS.'
...
complete -c moon -n "__fish_moon_using_subcommand debug; and __fish_seen_subcommand_from vcs" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand bin" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand node; and not __fish_seen_subcommand_from run-script" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand node; and __fish_seen_subcommand_from run-script" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand setup" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand teardown" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand action-graph" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand project" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand project-graph" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand task-graph" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand sync; and not __fish_seen_subcommand_from codeowners config-schemas hooks projects" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand sync; and __fish_seen_subcommand_from codeowners" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand sync; and __fish_seen_subcommand_from config-schemas" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand sync; and __fish_seen_subcommand_from hooks" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand sync; and __fish_seen_subcommand_from projects" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand task" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand generate" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand templates" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand check" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand ci" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand run" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand ext" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand clean" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand docker; and not __fish_seen_subcommand_from file prune scaffold setup" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand docker; and __fish_seen_subcommand_from file" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand docker; and __fish_seen_subcommand_from prune" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand docker; and __fish_seen_subcommand_from scaffold" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand docker; and __fish_seen_subcommand_from setup" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand migrate; and not __fish_seen_subcommand_from from-package-json from-turborepo" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand migrate; and __fish_seen_subcommand_from from-package-json" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand migrate; and __fish_seen_subcommand_from from-package-json" -l skip-touched-files-check
...
complete -c moon -n "__fish_moon_using_subcommand migrate; and __fish_seen_subcommand_from from-turborepo" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and not __fish_seen_subcommand_from hash hash-diff projects tasks touched-files" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from hash" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from hash-diff" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from projects" -l type -d 'Filter projects of this type' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from projects" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from tasks" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from touched-files" -l defaultBranch -d 'When on the default branch, compare against the previous revision' -r -f -a "true\t''
false\t''"
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from touched-files" -l log -d 'Lowest log level to output' -r
...
complete -c moon -n "__fish_moon_using_subcommand query; and __fish_seen_subcommand_from touched-files" -l local -d 'Gather files from you local state instead of the remote'
...
complete -c moon -n "__fish_moon_using_subcommand upgrade" -l log -d 'Lowest log level to output' -r
